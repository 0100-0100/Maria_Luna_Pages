...
AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': f'{AUTH}.UserAttributeSimilarityValidator',
    },
    {
        'NAME': f'{AUTH}.MinimumLengthValidator',
    },
    {
        'NAME': f'{AUTH}.CommonPasswordValidator',
    },
    {
        'NAME': f'{AUTH}.NumericPasswordValidator',
    },
]
...
STATIC_URL = 'static/'
STATIC_ROOT = BASE_DIR / '/var/www/sapzurro/static/' if not DEBUG else None
